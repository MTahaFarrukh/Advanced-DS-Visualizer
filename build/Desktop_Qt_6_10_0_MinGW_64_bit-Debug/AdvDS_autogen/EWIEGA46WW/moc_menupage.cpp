...
template <> constexpr inline auto MenuPage::qt_create_metaobjectdata<qt_meta_tag_ZN8MenuPageE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        "MenuPage",
        "dataStructureSelected",
        "",
        "dsName",
        "onTreeClicked",
        "onRedBlackTreeClicked",
        "onGraphClicked",
        "onHashTableClicked"
    };

    QtMocHelpers::UintData qt_methods {
        // Signal 'dataStructureSelected'
        QtMocHelpers::SignalData<void(const QString &)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QString, 3 },
        }}),
        // Slot 'onTreeClicked'
        QtMocHelpers::SlotData<void()>(4, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'onRedBlackTreeClicked'
        QtMocHelpers::SlotData<void()>(5, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'onGraphClicked'
        QtMocHelpers::SlotData<void()>(6, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'onHashTableClicked'
...
void MenuPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->dataStructureSelected((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        case 1: _t->onTreeClicked(); break;
        case 2: _t->onRedBlackTreeClicked(); break;
        case 3: _t->onGraphClicked(); break;
        case 4: _t->onHashTableClicked(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (MenuPage::*)(const QString & )>(_a, &MenuPage::dataStructureSelected, 0))
            return;
    }
}
...
// SIGNAL 0
void MenuPage::dataStructureSelected(const QString & _t1)
{
