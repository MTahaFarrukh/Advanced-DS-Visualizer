...
template <> constexpr inline auto OperationPage::qt_create_metaobjectdata<qt_meta_tag_ZN13OperationPageE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Signal 'operationSelected'
        QtMocHelpers::SignalData<void(const QString &)>(3, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QString, 4 },
        }}),
        // Slot 'onBackClicked'
        QtMocHelpers::SlotData<void()>(5, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'onInsertionClicked'
        QtMocHelpers::SlotData<void()>(6, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'onDeletionClicked'
        QtMocHelpers::SlotData<void()>(7, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'onSearchClicked'
        QtMocHelpers::SlotData<void()>(8, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'onTraversalClicked'
    ...
    return QtMocHelpers::metaObjectData<OperationPage, qt_meta_tag_ZN13OperationPageE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject OperationPage::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13OperationPageE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13OperationPageE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN13OperationPageE_t>.metaTypes,
    nullptr
} };
...
void OperationPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (OperationPage::*)()>(_a, &OperationPage::backToMenu, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (OperationPage::*)(const QString & )>(_a, &OperationPage::operationSelected, 1))
            return;
    }
}
...
void *OperationPage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13OperationPageE_t>.strings))
